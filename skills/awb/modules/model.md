...
- 给用户推荐模型时要说明候选通道的取舍：官方 / 折扣 / Fast / Pro / 1080p 等可能在价格、速度、队列、成功率、清晰度和参数上不同。
- 选定模型组前先问用户目标：试片省钱、速度优先、画质优先、主体一致性、多参考能力、声音 / 音色、横竖屏和时长。不要只按模型名猜。
...
- 提交前把最终模型组、通道、可传参数、用户已选参数、仍需用户决定的参数列清楚，再进入计费和确认。
